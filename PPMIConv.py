...
class PPMIConv(GCNConv):
    ...
    #    print("normed_walk_counters: ", normed_walk_counters)
      ...
      #  print("ppmis: ", ppmis) 
        ...
        print("weight: ", (deg_inv_sqrt[row] * edge_weight * deg_inv_sqrt[col]).type(torch.float32))

        return edge_index, (deg_inv_sqrt[row] * edge_weight * deg_inv_sqrt[col]).type(torch.float32) 

    def norm_update(edge_index, num_nodes, path_len, edge_weight=None, improved=False,
             dtype=None):
